...
struct midi_buffer {
	...
	unsigned int channel_mask; // One bit for each channel you want to
				   // listen to For example 0x02 to listen to
				   // channel 1 or 0x03 to listen to channels 0
				   // and 1. Defaults to 0xffff (all channels.)
